    ...
    public function run()
    {
        ...
        $categories = [
            ...
            [
                ...
                'name_en' => 'Office',
                'code' => 'office',
                'description' => 'Раздел с офисной техникой.',
                'description_en' => 'Section with offices.',
                'image' => 'categories/office.jpg',
                'products' => [
                    [
                        'name' => 'МФУ Pantum M6500',
                        'name_en' => 'MFU Pantum M6500',
                        'code' => 'pantum',
                        'description' => 'А4, лазерная ч.б., 22 стр/мин, 1200 x 1200 dpi, 128Мб RAM, лоток 150 стр, USB, черный',
                        'description_en' => 'A4, lazer b.w., 22 p/min, 1200 x 1200 dpi, 128 Mb RAM, USB, black',
                        'image' => 'products/pantum.jpg',
                        'properties' => [
                            1,
                        ],
                        'options' => [
